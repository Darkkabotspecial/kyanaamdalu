...
async def next_page(bot, query):
    ...
    if int(req) not in [query.from_user.id, 0]:
        return await query.answer("Please do not view other requests 😢. Request Again ", show_alert=True)
    try:
        offset = int(offset)
    except:
        offset = 0
    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                await query.answer('✌️ Hey Bro/Sis Check PM, I have sent files in pm 🤗 Thx For Using Me Bro I Like You \n\n',show_alert = True)
        ...
        buttons = [[
            InlineKeyboardButton('➕ Add Me To Your Groups ➕', "Plz Add By Yourself 😎")
            ],[
            InlineKeyboardButton('🔍 Search 🔍', switch_inline_query_current_chat=''),
            InlineKeyboardButton('🍿 Movie Channel 🍿', url='https://t.me/Cornersofficial')
            ],[
        ...
        await query.answer("Fetching My DataBase And Server! It Hurts It Hurts 🚀")
        buttons = [[
            InlineKeyboardButton('👩‍🦯 Back', callback_data='help'),
            InlineKeyboardButton('♻️ Refresh ♻️', callback_data='rfrsh')
        ]]
...
async def advantage_spell_chok(msg):
    ...
    gs_parsed = []
    if not g_s:
        k = await msg.reply("Sry I am Unable to Find That Movie")
    ...
    if not movielist:
        k = await msg.reply("I couldn't find anything related to that. Check your spelling . I AM SORRY ")
        await asyncio.sleep(8)
        await k.delete()
        return
